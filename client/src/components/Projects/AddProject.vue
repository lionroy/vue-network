  ...
  <v-container text-xs-center mt-5 pt-5>
    ...
    <v-layout row wrap>
      <v-flex xs12 sm6 offset-sm3>
        <h1 class="primary--text">Add Project</h1>
      </v-flex>
    </v-layout>
    ...
    <v-layout row wrap>
      <v-flex xs12 sm6 offset-sm3>
        ...
        <v-form v-model="isFormValid" lazy-validation ref="form" @submit.prevent="handleAddProject">

          <!-- Title Input -->
          <v-layout row>
            <v-flex xs12>
              <v-text-field :rules="titleRules" v-model="title" label="Project Title" type="text" required></v-text-field>
            </v-flex>
          </v-layout>
